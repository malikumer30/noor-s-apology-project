...
const LETTER_PARAGRAPHS = [
  ...
  "If you are willing, I would like to start with a conversation — no pressure, no expectations, just the two of us being honest about where we go from here. But I need you to know that I am not giving up on us. I am ready to do whatever it takes to show you that what we have is worth fighting for, because losing you is not something I can accept without trying with everything I have.",
